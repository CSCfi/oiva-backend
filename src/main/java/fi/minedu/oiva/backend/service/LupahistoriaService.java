...
public class LupahistoriaService {
    ...
    public Collection<Lupahistoria> getHistoriaByOid(String oid) {
        ...
        return dsl.select(LUPAHISTORIA.ID, LUPAHISTORIA.YTUNNUS, LUPAHISTORIA.OID, LUPAHISTORIA.VOIMASSAOLO,
                LUPAHISTORIA.DIAARINUMERO, LUPAHISTORIA.MAAKUNTA, LUPAHISTORIA.FILENAME, LUPAHISTORIA.PAATOSPVM).from(LUPAHISTORIA)
