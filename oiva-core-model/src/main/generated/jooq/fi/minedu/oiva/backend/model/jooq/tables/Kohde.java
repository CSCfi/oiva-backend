...
public class Kohde extends TableImpl<KohdeRecord> {
    ...
    private static final long serialVersionUID = 1781308170;
     ...
     */
    public final TableField<KohdeRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('kohde_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>kohde.tunniste</code>.
     */
    public final TableField<KohdeRecord, String> TUNNISTE = createField(DSL.name("tunniste"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>kohde.meta</code>.
     */
    public final TableField<KohdeRecord, JsonNode> META = createField(DSL.name("meta"), org.jooq.impl.SQLDataType.JSONB, this, "", new PostgresJSONJacksonBinding());

    /**
     * The column <code>kohde.luoja</code>.
     */
    public final TableField<KohdeRecord, String> LUOJA = createField(DSL.name("luoja"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>kohde.luontipvm</code>.
     */
    public final TableField<KohdeRecord, Timestamp> LUONTIPVM = createField(DSL.name("luontipvm"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>kohde.paivittaja</code>.
     */
    public final TableField<KohdeRecord, String> PAIVITTAJA = createField(DSL.name("paivittaja"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>kohde.paivityspvm</code>.
     */
    public final TableField<KohdeRecord, Timestamp> PAIVITYSPVM = createField(DSL.name("paivityspvm"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>kohde.uuid</code>.
     */
    public final TableField<KohdeRecord, UUID> UUID = createField(DSL.name("uuid"), org.jooq.impl.SQLDataType.UUID.nullable(false).defaultValue(org.jooq.impl.DSL.field("uuid_generate_v1()", org.jooq.impl.SQLDataType.UUID)), this, "");

    /**
     * The column <code>kohde.koulutustyyppi</code>.
     */
    public final TableField<KohdeRecord, String> KOULUTUSTYYPPI = createField(DSL.name("koulutustyyppi"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
