...
public class Muutos extends TableImpl<MuutosRecord> {
    ...
    private static final long serialVersionUID = -816267137;
     ...
     */
    public final TableField<MuutosRecord, String> KOODISTO = createField("koodisto", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
     ...
     */
    public final TableField<MuutosRecord, String> ARVO = createField("arvo", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
     ...
     */
    public final TableField<MuutosRecord, JsonNode> META = createField("meta", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonb\""), this, "", new PostgresJSONJacksonBinding());
     ...
     */
    public final TableField<MuutosRecord, String> TILA = createField("tila", org.jooq.impl.SQLDataType.VARCHAR(10), this, "");
     ...
     */
    public final TableField<MuutosRecord, String> PAATOS_TILA = createField("paatos_tila", org.jooq.impl.SQLDataType.VARCHAR(20), this, "");
     ...
     */
    public final TableField<MuutosRecord, String> ORG_OID = createField("org_oid", org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
