...
public class Liite extends TableImpl<LiiteRecord> {
    ...
    private static final long serialVersionUID = 202157007;
     ...
     */
    public final TableField<LiiteRecord, String> NIMI = createField("nimi", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>liite.polku</code>.
     */
    public final TableField<LiiteRecord, String> POLKU = createField("polku", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
     ...
     */
    public final TableField<LiiteRecord, JsonNode> META = createField("meta", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonb\""), this, "", new PostgresJSONJacksonBinding());

    /**
     * The column <code>liite.tyyppi</code>.
     */
    public final TableField<LiiteRecord, String> TYYPPI = createField("tyyppi", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>liite.kieli</code>.
     */
    public final TableField<LiiteRecord, String> KIELI = createField("kieli", org.jooq.impl.SQLDataType.VARCHAR(2).nullable(false), this, "");
     ...
     */
    public final TableField<LiiteRecord, String> PAIKKA = createField("paikka", org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>liite.tiedosto_id</code>.
     */
    public final TableField<LiiteRecord, String> TIEDOSTO_ID = createField("tiedosto_id", org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
