...
public class MuutospyyntoRecord extends UpdatableRecordImpl<MuutospyyntoRecord> implements Record21<Long, Long, Date, Date, Date, Long, String, String, String, Timestamp, String, Timestamp, UUID, JsonNode, String, String, Date, String, String, String, String> {

    private static final long serialVersionUID = 1720578865;
     ...
     */
    @Override
    public Row21<Long, Long, Date, Date, Date, Long, String, String, String, Timestamp, String, Timestamp, UUID, JsonNode, String, String, Date, String, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row21<Long, Long, Date, Date, Date, Long, String, String, String, Timestamp, String, Timestamp, UUID, JsonNode, String, String, Date, String, String, String, String> valuesRow() {
     ...
     */
    public MuutospyyntoRecord(Long id, Long lupaId, Date hakupvm, Date voimassaalkupvm, Date voimassaloppupvm, Long paatoskierrosId, String tila, String jarjestajaYtunnus, String luoja, Timestamp luontipvm, String paivittaja, Timestamp paivityspvm, UUID uuid, JsonNode meta, String alkupera, String asianumero, Date paatospvm, String diaarinumero, String jarjestajaOid, String koulutustyyppi, String kieli) {
        super(Muutospyynto.MUUTOSPYYNTO);
