...
public class Tables {
     ...
     */
    public static final Asiatyyppi ASIATYYPPI = fi.minedu.oiva.backend.model.jooq.tables.Asiatyyppi.ASIATYYPPI;

    /**
     * The table <code>esitysmalli</code>.
     */
    public static final Esitysmalli ESITYSMALLI = fi.minedu.oiva.backend.model.jooq.tables.Esitysmalli.ESITYSMALLI;

    /**
     * The table <code>kohde</code>.
     */
    public static final Kohde KOHDE = fi.minedu.oiva.backend.model.jooq.tables.Kohde.KOHDE;

    /**
     * The table <code>liite</code>.
     */
    public static final Liite LIITE = fi.minedu.oiva.backend.model.jooq.tables.Liite.LIITE;

    /**
     * The table <code>lupa</code>.
     */
    public static final Lupa LUPA = fi.minedu.oiva.backend.model.jooq.tables.Lupa.LUPA;

    /**
     * The table <code>lupahistoria</code>.
     */
    public static final Lupahistoria LUPAHISTORIA = fi.minedu.oiva.backend.model.jooq.tables.Lupahistoria.LUPAHISTORIA;

    /**
     * The table <code>lupa_liite</code>.
     */
    public static final LupaLiite LUPA_LIITE = fi.minedu.oiva.backend.model.jooq.tables.LupaLiite.LUPA_LIITE;

    /**
     * The table <code>lupatila</code>.
     */
    public static final Lupatila LUPATILA = fi.minedu.oiva.backend.model.jooq.tables.Lupatila.LUPATILA;

    /**
     * The table <code>maarays</code>.
     */
    public static final Maarays MAARAYS = fi.minedu.oiva.backend.model.jooq.tables.Maarays.MAARAYS;

    /**
     * The table <code>maaraystyyppi</code>.
     */
    public static final Maaraystyyppi MAARAYSTYYPPI = fi.minedu.oiva.backend.model.jooq.tables.Maaraystyyppi.MAARAYSTYYPPI;

    /**
     * The table <code>muutos</code>.
     */
    public static final Muutos MUUTOS = fi.minedu.oiva.backend.model.jooq.tables.Muutos.MUUTOS;

    /**
     * The table <code>muutos_liite</code>.
     */
    public static final MuutosLiite MUUTOS_LIITE = fi.minedu.oiva.backend.model.jooq.tables.MuutosLiite.MUUTOS_LIITE;
