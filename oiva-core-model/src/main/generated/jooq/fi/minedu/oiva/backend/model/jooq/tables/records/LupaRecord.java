...
public class LupaRecord extends UpdatableRecordImpl<LupaRecord> implements Record20<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID, String, String> {

    private static final long serialVersionUID = -16069212;
     ...
     */
    @Override
    public Row20<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row20<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID, String, String> valuesRow() {
     ...
     */
    public LupaRecord(Long id, Long edellinenLupaId, Long paatoskierrosId, Long lupatilaId, Long asiatyyppiId, String diaarinumero, String jarjestajaYtunnus, String jarjestajaOid, Date alkupvm, Date loppupvm, Date paatospvm, JsonNode meta, Boolean maksu, String luoja, Timestamp luontipvm, String paivittaja, Timestamp paivityspvm, UUID uuid, String koulutustyyppi, String oppilaitostyyppi) {
        super(Lupa.LUPA);
