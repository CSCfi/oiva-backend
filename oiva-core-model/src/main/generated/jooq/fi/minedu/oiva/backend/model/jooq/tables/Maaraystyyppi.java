...
public class Maaraystyyppi extends TableImpl<MaaraystyyppiRecord> {
    ...
    private static final long serialVersionUID = -1667724881;
     ...
     */
    public final TableField<MaaraystyyppiRecord, MaaraystyyppiValue> TUNNISTE = createField("tunniste", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "", new Converter());

    /**
     * The column <code>maaraystyyppi.selite</code>.
     */
    public final TableField<MaaraystyyppiRecord, TranslatedString> SELITE = createField("selite", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"jsonb\""), this, "", new TranslatedStringBinding());
