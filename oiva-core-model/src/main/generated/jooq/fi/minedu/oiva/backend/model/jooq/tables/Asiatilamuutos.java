...
public class Asiatilamuutos extends TableImpl<AsiatilamuutosRecord> {
    ...
    private static final long serialVersionUID = -1982050630;
     ...
     */
    public final TableField<AsiatilamuutosRecord, String> ALKUTILA = createField("alkutila", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>asiatilamuutos.lopputila</code>.
     */
    public final TableField<AsiatilamuutosRecord, String> LOPPUTILA = createField("lopputila", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
