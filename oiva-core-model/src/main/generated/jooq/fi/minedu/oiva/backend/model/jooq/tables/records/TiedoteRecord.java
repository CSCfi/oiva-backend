...
public class TiedoteRecord extends UpdatableRecordImpl<TiedoteRecord> implements Record8<Long, JsonNode, JsonNode, String, Timestamp, String, Timestamp, UUID> {

    private static final long serialVersionUID = -1871588185;

    /**
     * Setter for <code>tiedote.id</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.id</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>tiedote.otsikko</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.otsikko</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>tiedote.sisalto</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.sisalto</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>tiedote.luoja</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.luoja</code>.
     */
    @NotNull
    @Size(max = 255)
    ...
    /**
     * Setter for <code>tiedote.luontipvm</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.luontipvm</code>.
     */
    ...
    /**
     * Setter for <code>tiedote.paivittaja</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.paivittaja</code>.
     */
    @NotNull
    @Size(max = 255)
    ...
    /**
     * Setter for <code>tiedote.paivityspvm</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.paivityspvm</code>.
     */
    ...
    /**
     * Setter for <code>tiedote.uuid</code>.
     */
    ...
    /**
     * Getter for <code>tiedote.uuid</code>.
     */
    public UUID getUuid() {
        return (UUID) get(7);
    }
     ...
     */
    @Override
    public Row8<Long, JsonNode, JsonNode, String, Timestamp, String, Timestamp, UUID> fieldsRow() {
     ...
     */
    @Override
    public Row8<Long, JsonNode, JsonNode, String, Timestamp, String, Timestamp, UUID> valuesRow() {
     ...
     */
    @Override
    public TiedoteRecord value8(UUID value) {
        setUuid(value);
        return this;
    }
     ...
     */
    @Override
    public TiedoteRecord values(Long value1, JsonNode value2, JsonNode value3, String value4, Timestamp value5, String value6, Timestamp value7, UUID value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TiedoteRecord(Long id, JsonNode otsikko, JsonNode sisalto, String luoja, Timestamp luontipvm, String paivittaja, Timestamp paivityspvm, UUID uuid) {
        super(Tiedote.TIEDOTE);
