...
public class LupaRecord extends UpdatableRecordImpl<LupaRecord> implements Record18<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID> {

    private static final long serialVersionUID = -2139937983;

    /**
     * Setter for <code>kuja.lupa.id</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.id</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>kuja.lupa.edellinen_lupa_id</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.edellinen_lupa_id</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.paatoskierros_id</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.paatoskierros_id</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>kuja.lupa.lupatila_id</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.lupatila_id</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>kuja.lupa.asiatyyppi_id</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.asiatyyppi_id</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>kuja.lupa.diaarinumero</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.diaarinumero</code>.
     */
    @Size(max = 20)
    ...
    /**
     * Setter for <code>kuja.lupa.jarjestaja_ytunnus</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.jarjestaja_ytunnus</code>.
     */
    @NotNull
    @Size(max = 10)
    ...
    /**
     * Setter for <code>kuja.lupa.jarjestaja_oid</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.jarjestaja_oid</code>.
     */
    @NotNull
    @Size(max = 255)
    ...
    /**
     * Setter for <code>kuja.lupa.alkupvm</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.alkupvm</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>kuja.lupa.loppupvm</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.loppupvm</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.paatospvm</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.paatospvm</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.meta</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.meta</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.maksu</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.maksu</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.luoja</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.luoja</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.luontipvm</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.luontipvm</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.paivittaja</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.paivittaja</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.paivityspvm</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.paivityspvm</code>.
     */
    ...
    /**
     * Setter for <code>kuja.lupa.uuid</code>.
     */
    ...
    /**
     * Getter for <code>kuja.lupa.uuid</code>.
     */
    public UUID getUuid() {
        return (UUID) get(17);
    }
     ...
     */
    @Override
    public Row18<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID> fieldsRow() {
     ...
     */
    @Override
    public Row18<Long, Long, Long, Long, Long, String, String, String, Date, Date, Date, JsonNode, Boolean, String, Timestamp, String, Timestamp, UUID> valuesRow() {
     ...
     */
    @Override
    public LupaRecord values(Long value1, Long value2, Long value3, Long value4, Long value5, String value6, String value7, String value8, Date value9, Date value10, Date value11, JsonNode value12, Boolean value13, String value14, Timestamp value15, String value16, Timestamp value17, UUID value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LupaRecord(Long id, Long edellinenLupaId, Long paatoskierrosId, Long lupatilaId, Long asiatyyppiId, String diaarinumero, String jarjestajaYtunnus, String jarjestajaOid, Date alkupvm, Date loppupvm, Date paatospvm, JsonNode meta, Boolean maksu, String luoja, Timestamp luontipvm, String paivittaja, Timestamp paivityspvm, UUID uuid) {
        super(Lupa.LUPA);
