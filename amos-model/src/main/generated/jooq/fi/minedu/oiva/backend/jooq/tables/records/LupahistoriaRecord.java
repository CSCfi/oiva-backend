...
public class LupahistoriaRecord extends UpdatableRecordImpl<LupahistoriaRecord> implements Record14<Long, String, String, String, String, String, Date, Date, Date, String, UUID, String, Date, Long> {

    private static final long serialVersionUID = 1091090299;
    ...
    /**
     * Setter for <code>oiva.lupahistoria.voimassaoloalkupvm</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.voimassaoloalkupvm</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>oiva.lupahistoria.voimassaololoppupvm</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.voimassaololoppupvm</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>oiva.lupahistoria.uuid</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.uuid</code>.
     */
    public UUID getUuid() {
        return (UUID) get(10);
    }
    ...
    /**
     * Setter for <code>oiva.lupahistoria.asianumero</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.asianumero</code>.
     */
    @Size(max = 16)
    ...
    /**
     * Setter for <code>oiva.lupahistoria.kumottupvm</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.kumottupvm</code>.
     */
    ...
    /**
     * Setter for <code>oiva.lupahistoria.lupa_id</code>.
     */
    ...
    /**
     * Getter for <code>oiva.lupahistoria.lupa_id</code>.
     */
     ...
     */
    @Override
    public Row14<Long, String, String, String, String, String, Date, Date, Date, String, UUID, String, Date, Long> fieldsRow() {
     ...
     */
    @Override
    public Row14<Long, String, String, String, String, String, Date, Date, Date, String, UUID, String, Date, Long> valuesRow() {
     ...
     */
    @Override
    public LupahistoriaRecord values(Long value1, String value2, String value3, String value4, String value5, String value6, Date value7, Date value8, Date value9, String value10, UUID value11, String value12, Date value13, Long value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LupahistoriaRecord(Long id, String diaarinumero, String ytunnus, String oid, String maakunta, String tila, Date voimassaoloalkupvm, Date voimassaololoppupvm, Date paatospvm, String filename, UUID uuid, String asianumero, Date kumottupvm, Long lupaId) {
        super(Lupahistoria.LUPAHISTORIA);
